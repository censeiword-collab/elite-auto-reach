...
const homeFAQ = [
  {
    ...
    answer: "Стоимость оклейки PPF зависит от выбранной зоны защиты и модели автомобиля. Полная оклейка кузова начинается от 150 000 ₽, защита передней части — от 45 000 ₽, капота — от 15 000 ₽. Используем премиальные плёнки XPEL и SunTek с гарантией до 10 лет.",
  },
  {
  ...
  },
  {
    ...
    answer: "Комплексная шумоизоляция автомобиля занимает от 2 до 5 дней в зависимости от объёма работ. Полная шумоизоляция снижает уровень шума на 40-60%. Используем материалы StP и Dynamat.",
  },
  {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Профессиональный детейлинг и тюнинг автомобилей премиум-класса в Казани. Оклейка PPF, активный выхлоп, шумоизоляция, PDR, сигнализации Pandora. Гарантия до 10 лет."
        keywords={[
          "детейлинг казань",
          "оклейка ppf казань",
