...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Да, работаем с ИП и организациями. Предоставляем полный пакет документов: договор, акт выполненных работ. Возможен безналичный расчёт."
      },
    ]
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Мы работаем с плёнками премиум-сегмента от ведущих производителей. Все плёнки имеют гарантию производителя от 5 до 10 лет в зависимости от модели. Конкретные бренды уточняйте при записи."
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "Можно ли сделать работу срочно?",
        a: "Срочные заказы возможны при наличии свободных слотов. Уточняйте при записи — постараемся подобрать удобное время."
      },
    ]
  },
  {
    ...
    questions: [
      {
        ...
        a: "Гарантия зависит от услуги: PPF — до 10 лет, тонировка — до 5 лет, шумоизоляция — до 3 лет, установка оборудования — до 2 лет, PDR — пожизненная на выполненную работу."
      },
      {
    ...
    questions: [
      {
        ...
        a: "Наличные, банковские карты, безналичный расчёт для юридических лиц. Возможность рассрочки уточняйте при записи."
      },
      {
      ...
      },
      {
        ...
        a: "Условия предоплаты зависят от объёма работ. Детали обсуждаем при записи."
      },
    ]
  },
  {
    ...
    questions: [
      ...
      {
        q: "Даёте ли вы рекомендации по уходу после работ?",
        a: "Да, после выполнения работ мы предоставляем памятку по уходу и рекомендации для продления срока службы покрытий."
      },
    ]
  },
];
