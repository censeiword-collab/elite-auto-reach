...
const BENEFITS = [
  { icon: Shield, title: "PPF премиум-класса", desc: "Плёнки ведущих мировых брендов с гарантией до 10 лет" },
...
const FAQ_ITEMS = [
  ...
  { q: "Какие плёнки используете?", a: "Работаем с премиальными брендами: STEK, Llumar, Suntek, XPEL. Все плёнки сертифицированы и имеют гарантию производителя." },
