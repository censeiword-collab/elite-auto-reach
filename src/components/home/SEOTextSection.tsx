    ...
    <section className="section-container border-t border-border">
      ...
      >
        ...
        <div className="prose prose-invert prose-lg max-w-none text-muted-foreground space-y-6">
          <p>
            <strong className="text-foreground">AutoService</strong> — ведущий премиальный автосервис в Казани, специализирующийся на защите кузова, тюнинге и повышении комфорта автомобилей премиум-класса. Мы работаем с такими марками, как Porsche, BMW, Mercedes-Benz, Audi, Lexus, Land Rover и другими престижными брендами. Наша команда сертифицированных мастеров использует только профессиональные материалы мировых производителей.
          </p>

          <p>
            <strong className="text-foreground">Оклейка автомобиля полиуретановой плёнкой (PPF) в Казани</strong> — одна из наших ключевых услуг. Мы работаем с лучшими плёнками на рынке: XPEL Ultimate Plus, SunTek PPF, Hexis Bodyfence. Защитная плёнка предохраняет лакокрасочное покрытие от сколов, царапин, реагентов и ультрафиолета. Гарантия на плёнку и работу — до 10 лет. Предлагаем как полную оклейку кузова, так и защиту отдельных зон: капота, бамперов, порогов, зеркал.
          </p>
          ...
          <p>
            <strong className="text-foreground">Установка сигнализации Pandora с автозапуском в Казани</strong> — надёжная защита и максимальный комфорт. Системы Pandora обеспечивают многоуровневую защиту от угона, GPS-мониторинг, автозапуск двигателя и управление со смартфона. Устанавливаем весь модельный ряд: от Pandora DX до Pandora DXL с интеграцией в штатные системы автомобиля.
          </p>

          <p className="text-center text-foreground font-medium">
            Запишитесь на бесплатную консультацию и расчёт стоимости. Работаем по адресу: Казань, ул. Примерная, 123. 
            Телефон: +7 (999) 123-45-67. Ждём вас!
          </p>
        </div>
      </motion.div>
    </section>
